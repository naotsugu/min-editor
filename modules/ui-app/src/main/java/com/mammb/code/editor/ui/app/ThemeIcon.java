...
public class ThemeIcon extends SVGPath {
    ...
    public static ThemeIcon alt(ThemeColor tc) {
        return new ThemeIcon(tc, "M11 0H3a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2 2 2 0 0 0 2-2V4a2 2 0 0 0-2-2 2 2 0 0 0-2-2zm2 3a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1V3zM2 2a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V2z");
    }

    public static ThemeIcon list(ThemeColor tc) {
        return new ThemeIcon(tc, "M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z");
    }
    ...
    private void initHandler() {
        disabledProperty().addListener((ob, o, n) ->
            setFill(n ? themeColor.foregroundDisable() : themeColor.foreground()));
    }
