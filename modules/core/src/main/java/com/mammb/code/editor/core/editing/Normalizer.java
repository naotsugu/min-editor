...
public class Normalizer {
    ...
    /**
     * Converts from full width to half width ascii as much as possible with the given mapping table.
     * @param str string to convert
     * @return converted string.
     */
    static String fullToAscii(String str) {
        if (str == null || str.isBlank()) {
            return str;
        }
        return str.codePoints()
            .mapToObj(Character::toString)
            .map(s -> fullToAscii.getOrDefault(s, s))
            .collect(Collectors.joining());
    }

    /** The map of full to ascii. */
    private static final Map<String, String> fullToAscii = Map.<String, String>ofEntries(
    ...
    /** The map of full kana to half. */
    private static final Map<String, String> fullKanaToHalf = Map.<String, String>ofEntries(
